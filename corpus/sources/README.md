...
The latest score was taken on 2026-09-25 at engine `504c50d` on Darwin arm64.
...
opens every workbook and observes 980,792 formula cells.
`enron-figshare.score-delta.json` remains the 2026-09-08 paired comparison
...
| Owned engine lane | 2026-09-08 (`12d1c8c`) | 2026-09-24 (`f08a50a`) | 2026-09-25 (`405867e`) | 2026-09-25 (`504c50d`) |
|---|---:|---:|---:|---:|
| Workbooks opened | 996 / 1,000 | 996 / 1,000 | 998 / 1,000 | 1,000 / 1,000 |
| Formula cells observed | 924,235 | 924,235 | 980,734 | 980,792 |
| Loaded and compared | 829,529 (89.75%) | 881,148 (95.34%) | 934,478 (95.28%) | 934,536 (95.28%) |
| Stored values matched | 828,437 | 874,541 | 928,272 | 929,898 |
| Match rate of compared | 99.87% | 99.25% | 99.34% | 99.50% |
| Stored values mismatched | 1,092 | 6,607 | 6,206 | 4,638 |
| Not compiled | 94,706 | 43,087 | 46,256 | 46,256 |

This pass is commit `504c50d`. Every workbook opened. The two workbooks that
declare the 1904 date system match all 58 formulas. The Monte Carlo workbook
matches all 2,007 formulas; its 1,568 cached `RAND()` draws, previously
`#N/A`, now match. Those three files are the entire movement. Not compiled
stays 46,256. The score process took about 141 seconds. Owned peak RSS was
11,889,229,824 bytes. Skipped sheets stay 51 across 24 workbooks.

First-failure groups are 8,672 external workbook references, 30,084
unsupported functions, 7,495 cycles, and 5 structured references. The options
model still holds 3,374 mismatches: 2,681 number-versus-number, 560 `#DIV/0!`
against `#VALUE!`, 82 `#N/A` against `#VALUE!`, and 51 number against `#N/A`.
Eighty `number → #N/A` cells remain in the sample, 51 of them on that model.
